...
vpnekranresim = cv2.imread('vpnekran.png', cv2.IMREAD_COLOR)
chsecimresim = cv2.imread('chsecimekrani.png', cv2.IMREAD_COLOR)
loginekranresim = cv2.imread('loginekran.png', cv2.IMREAD_COLOR)
baglantiekranresim = cv2.imread('baglantiekran.png', cv2.IMREAD_COLOR)
karakterekranresim = cv2.imread('karakterekran.png', cv2.IMREAD_COLOR)
karakterolusturresim = cv2.imread('karakterolustur.png', cv2.IMREAD_COLOR)
...
def autologin(wins_param):
    ...
    while True:
        ...
        # vpnsorgu = vpnresimsorgulama(vpnekranresim)
