...
sayi = 1
torch.load("kendiyapim1ve2.pt", weights_only=False)
model = YOLO("kendiyapim1ve2.pt")
    ...
    if not x == None:
        ...
        if not tiklandimi == False: # metine tıklandı anlamına geliyor
            ...
            for i in range(60): # 60 saniye dönecek
                ...
                print("tiklandı for döngüsüne girdi")
                print(stuck)
                if i == 0:
                    i = 1
                    counter2 = 0
                    ...
                    if metinvarmi:
                        ...
                        if not metincanazaliyomu:
                            ...
                            for move in directions[:move_count]:
                                ...
                                time.sleep(0.1)
                                pydirectinput.keyUp("z")
                                print(f"Moved {move} for {hold_time:.2f} sec")
